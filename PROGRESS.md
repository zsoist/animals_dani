...
- Teclado numérico propio, feedback, pista, reinyección y persistencia de intentos.
...
## Límites honestos
- No se ejecutó una sesión completa de diez respuestas en navegador automatizado.
- No se midió Lighthouse móvil, FPS real en 4G ni draw calls.
- El CRUD de habilidades del tutor quedó reducido al catálogo de lectura para mantener la interfaz simple solicitada.
