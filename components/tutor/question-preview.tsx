...
export function QuestionPreview({ question }: { question: CustomQuestion }) {
  ...
  return <div className="question-trial">
    ...
    <label>Prueba una respuesta<input value={answer} onChange={e => {setAnswer(e.target.value); setFeedback("");}} placeholder={question.answerFormat === "expression" ? "Por ejemplo F/a" : "Número, fracción o coeficientes"} /></label>
